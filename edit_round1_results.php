...
<div class="container-fluid">
  <div class="row d-flex">
    <?php
        ...
        echo '<form action="submit_round1_results.php" method="post">'; 
    ...
    ?>
      ...
      <!-- select time for the 2nd round -->
      <div class="mb-3">
          <label for="round2time" class="text-white"><h5><strong>Select 2nd Round Timing</strong></h5></label><br>
          <input class="formInput" name="round2time" type="datetime-local">
      </div>

      <div class="container">
        <div class="row">
          <div class="col text-center">
            <button name="nextRound" type="submit" class="btn btn-secondary">Generate Next Round</button>
          </div>
        </div>
      </div>    
